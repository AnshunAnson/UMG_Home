...
export default function Footer() {
  ...
  return (
    <footer className="bg-transparent">
      <div className="px-6 md:px-12 lg:px-20 py-10 lg:py-12">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          ...
          >
            <p className="font-display text-2xl font-semibold tracking-[-0.05em] text-white">
              {footer.logo}
              <span className="text-[#00d4aa]">{footer.logoHighlight}</span>
            </p>
            <p className="mt-3 max-w-md text-sm leading-7 text-white/42">{footer.tagline}</p>
          </motion.div>
