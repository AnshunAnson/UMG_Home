...
export const projectsContent: ProjectsContent = {
  ...
  "projects": [
    ...
    },
    {
      ...
      "title": "UI 材质动画作品",
      "period": "未单独标注",
      "category": "UI 材质 / 界面动效 / Material Animation",
      "description": "围绕界面材质、参数驱动和状态转场整理的一组 UI 材质动画展示，重点强调材质动画在界面层的节奏、质感和连续性，而不是作为 HMI 子项混合出现。",
      "details": [
        "把界面材质变化、参数动画和转场组织单独抽离成完整项目表达。",
        "重点展示 UI 材质在状态反馈、层级切换和动态质感上的控制能力。",
        "将原本挂在 HMI 项目下的案例独立出来，明确它属于 UI 材质动画能力而非 HMI 子项。"
      ],
      "achievements": [
        "补齐了个人主页里 UI 材质动画方向的独立项目样本。",
        "让界面材质动态能力不再依附于座舱或 HMI 场景叙事。",
    ...
    },
    {
      ...
      "title": "特效作品",
      "period": "未单独标注",
      "category": "特效 / VDB / Chaos",
      "description": "以 VDB 体积表现结合 Chaos 破碎流程完成的一次特效实验，核心是验证破碎层次、体积氛围和冲击感塑形，这个方向独立于 HMI 与界面项目本身。",
      "details": [
        "将 VDB 体积效果与 Chaos 破碎系统结合，强化破碎瞬间的空间感和层次感。",
        "关注碎裂过程中的形态变化、体积氛围和整体视觉冲击力。",
        "把这一类偏特效实验的内容从 HMI 项目里拆出，作为单独的特效能力条目展示。"
      ],
      "achievements": [
        "补充了个人主页在体积特效和破碎表现上的独立案例。",
        "让特效实验类项目不再混入界面或座舱项目的叙事中。",
        "形成一个清晰的 VDB 与 Chaos 特效方向外部展示入口。"
      ],
      "tech": [
        "UE",
        "VDB",
