...
export const heroContent: HeroContent = {
  ...
  "subtitle": "聚焦实时视觉、材质系统、Niagara 粒子、UMG重构、界面动效、编辑器工具与渲染流程，把表现需求收束成可交付的技术方案。"
};
  ...
  "projects": [
    {
      ...
      "title": "AI实战",
      "period": "2026.05.11",
      "category": "AI / Integration Tool / Stage Control / Real-time Communication",
    ...
    },
    {
      ...
      "title": "MetaHuman数字人",
      "period": "未单独标注",
      "category": "Metahuman / MetaHuman / Real-time Character",
      "tech": [
        "UE5",
        "MetaHuman",
        "Control Rig",
